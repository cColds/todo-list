...
const taskCard = (function () {
	...
	const _createTaskCard = (task) => {
		tasks.push(task);
		console.log((0,_task__WEBPACK_IMPORTED_MODULE_1__.todayTask)());
...
function createTask() {
	...
	const formattedDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(month, day, year), "MM-dd-yyyy");
...
function todayTask() {
	...
	console.log(_domManipulation__WEBPACK_IMPORTED_MODULE_1__.taskCard.getTask());
	const todayTask = _domManipulation__WEBPACK_IMPORTED_MODULE_1__.taskCard.getTask().forEach((task) => {
		// console.log(
		// 	dateDifference(
