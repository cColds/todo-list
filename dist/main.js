...
function createTask() {
	...
	if (dueDate)
		formattedDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(dueDate), "MMMM d, EEEE, y, K:mm a");
