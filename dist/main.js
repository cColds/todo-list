...
console.log((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date("2022-10-14T21:21")));
...
const taskModal = (function () {
	...
	const checkTodayTaskValidity = () => {
		if ((0,_task__WEBPACK_IMPORTED_MODULE_1__.getTaskNameIndex)() === 1 && !(0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(dueDate.value))) {
			dueDateDisplayError();
			return "error";
	...
	const toggleTaskModal = () => {
		...
		if ((0,_task__WEBPACK_IMPORTED_MODULE_1__.getTaskNameIndex)() === 1)
...
const taskCard = (function () {
	const render = () => {
		_pubSub__WEBPACK_IMPORTED_MODULE_0__.pubSub.subscribe("task-created", _createTaskCard);
		_pubSub__WEBPACK_IMPORTED_MODULE_0__.pubSub.subscribe("task-completed", _completedTaskCard);

		_pubSub__WEBPACK_IMPORTED_MODULE_0__.pubSub.subscribe("task-selected", () => {
			updateTaskCounter((0,_task__WEBPACK_IMPORTED_MODULE_1__.getTaskNameIndex)());
			deleteAllDomTasks();
			console.log(_task__WEBPACK_IMPORTED_MODULE_1__.tasks);
			(0,_task__WEBPACK_IMPORTED_MODULE_1__.todayTask)();
			_task__WEBPACK_IMPORTED_MODULE_1__.tasks[(0,_task__WEBPACK_IMPORTED_MODULE_1__.getTaskNameIndex)()].forEach((task) => {
	...
	const updateTaskCounter = (taskNameIndex) => {
		...
		taskCounter.textContent = `Tasks: ${_task__WEBPACK_IMPORTED_MODULE_1__.tasks[taskNameIndex].length}`;
	};
	...
	const _createTaskCard = (task) => {
		...
		taskCardContainer.dataset.task = `task${_task__WEBPACK_IMPORTED_MODULE_1__.tasks[0].length - 1}`;
