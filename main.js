...
const taskCard = (function () {
	...
	const updateTaskCounter = () => {
		const todayTaskLength = (0,_task__WEBPACK_IMPORTED_MODULE_1__.filterTodayTasks)().length;
		const taskLength =
			(0,_task__WEBPACK_IMPORTED_MODULE_1__.getTaskNameIndex)() !== 0 ? todayTaskLength : _task__WEBPACK_IMPORTED_MODULE_1__.tasks.length;
