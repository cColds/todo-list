...
let currentTaskId = [];
_task_populateTasks__WEBPACK_IMPORTED_MODULE_3__.getCurrentTaskId;
...
_pubsub__WEBPACK_IMPORTED_MODULE_1__.pubSub.subscribe("edit-task-clicked", (e) => {
	(0,_modalFunctionality__WEBPACK_IMPORTED_MODULE_2__.toggleModal)(modal, overlayModal);
	console.log(e);
});
