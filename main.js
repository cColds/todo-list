...
const setEditTaskValues = (task) => {
	...
	if (task.dueDate !== "Invalid Date")
		dueDate.value = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(task.dueDate));
