...
const taskModal = (function () {
	...
	const checkDateValidity = () => {
		...
		if ((0,_task__WEBPACK_IMPORTED_MODULE_1__.getTaskNameIndex)() === 2 && !(0,_task__WEBPACK_IMPORTED_MODULE_1__.isFuture)(new Date(dueDate.value))) {
			dateDisplayError();
...
const taskCard = (function () {
	...
	const taskToDisplay = () => {
		if ((0,_task__WEBPACK_IMPORTED_MODULE_1__.getTaskNameIndex)() === 0) {
			deleteAllDomTasks();
			_task__WEBPACK_IMPORTED_MODULE_1__.tasks.forEach((task) => _createTaskCard(task));
		} else if ((0,_task__WEBPACK_IMPORTED_MODULE_1__.getTaskNameIndex)() === 1) {
			todayTask();
		} else {
			upcomingTask();
	...
	const upcomingTask = () => {
		deleteAllDomTasks();
		if ((0,_task__WEBPACK_IMPORTED_MODULE_1__.filterUpcomingTasks)().length !== 0) {
			(0,_task__WEBPACK_IMPORTED_MODULE_1__.filterUpcomingTasks)().forEach((task) => _createTaskCard(task));
		}
		updateTaskCounter();
	};
	...
	const todayTask = () => {
		deleteAllDomTasks();
		if ((0,_task__WEBPACK_IMPORTED_MODULE_1__.filterTodayTasks)().length !== 0) {
			(0,_task__WEBPACK_IMPORTED_MODULE_1__.filterTodayTasks)().forEach((task) => _createTaskCard(task));
		}
		updateTaskCounter();
	};
	...
	const getTaskLength = () => {
		if ((0,_task__WEBPACK_IMPORTED_MODULE_1__.getTaskNameIndex)() === 0) return _task__WEBPACK_IMPORTED_MODULE_1__.tasks.length;
		if ((0,_task__WEBPACK_IMPORTED_MODULE_1__.getTaskNameIndex)() === 1) return (0,_task__WEBPACK_IMPORTED_MODULE_1__.filterTodayTasks)().length;
		if ((0,_task__WEBPACK_IMPORTED_MODULE_1__.getTaskNameIndex)() === 2) return (0,_task__WEBPACK_IMPORTED_MODULE_1__.filterUpcomingTasks)().length;
	};
	...
	const renderNewDataIndex = () => {
		...
		if ((0,_task__WEBPACK_IMPORTED_MODULE_1__.getTaskNameIndex)() === 0) {
			...
			taskClass.forEach((task) => {
				for (const taskId of (0,_task__WEBPACK_IMPORTED_MODULE_1__.filterTodayTasks)()) {
					task.dataset.task = `task${taskId.id}`;
				}
			});
		} else {
			taskClass.forEach((task) => {
				for (const taskId of (0,_task__WEBPACK_IMPORTED_MODULE_1__.filterUpcomingTasks)()) {
					task.dataset.task = `task${taskId.id}`;
				}
			});
		}
