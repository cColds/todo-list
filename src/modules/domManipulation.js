...
const createDomProject = (function () {
    ...
    <path fill="currentColor" d="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z" />
		...
		projectDeleteEl.addEventListener("click", (e) =>
			pubSub.publish("project-delete-clicked", e)
		);
	};
	...
	const projectSettingSvg = (projectUtilitiesRight) => {
		...
		projectSettingEl.addEventListener("click", (e) => {
			pubSub.publish("project-setting-clicked", e);
		});
	};
...
const deleteProject = (function () {
	const render = () => {
		pubSub.subscribe("project-delete-clicked", deleteDisplayProject);
	};
	...
	const deleteDisplayProject = (e) => {
		...
		deleteProjectObject(e);
		pubSub.publish("project-deleted");
	};
...
const updateProjects = (function () {
	const render = () => {
		...
		pubSub.subscribe("project-deleted", updateProjectCounter);
	};
	...
	const render = () => {
		...
		editProjectSave.addEventListener("click", () => {
			if (checkNewTitleValidity(editProjectTitleInput.value)) {
				toggleEditProjectModal();
				pubSub.publish("edited-project", editProjectTitleInput.value);
			}
		});
